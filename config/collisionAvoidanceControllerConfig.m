...
function cfg = localDefaults()
    ...
    cfg.solver = struct( ...
        "jointFunction", [], ...
        "maxIterations", 400, ...
        "admissionMaximumFamilies", 4, ...
        "admissionMaximumIterations", 4, ...
...
function localValidate(cfg)
    ...
    validateattributes(cfg.solver.admissionMaximumFamilies,{'double'},{'scalar','integer','positive','finite','<=',32});
    validateattributes(cfg.solver.admissionMaximumIterations,{'double'},{'scalar','integer','positive','finite','<=',20});
