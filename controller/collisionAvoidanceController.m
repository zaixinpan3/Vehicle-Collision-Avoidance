...
% Distance-dual convexification uses finite branches only for initialization.
% An exhausted or incomplete search returns no control command.
    ...
    formulationSeconds=0;solveSeconds=0;conicCalls=0;distanceCalls=0;integerCalls=0;horizonAttempts=0;
    solverCfg = cfg;
    ...
    metadata = struct('solverCallCount',conicCalls+distanceCalls+integerCalls,'solverExitFlag',result.exitFlag, ...
        'conicSolverCallCount',conicCalls+distanceCalls,'integerSolverCallCount',integerCalls, ...
    ...
    controllerState = struct('version',30,'appliedInput',firstInput,'stateTime',model.stateTime, ...
