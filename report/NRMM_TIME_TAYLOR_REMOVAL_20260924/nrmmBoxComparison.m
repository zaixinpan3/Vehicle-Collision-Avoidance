...
% the nrmm-motion-v1 contract the estimator publishes (curvature maximum
% sin(beta_max)/l_r, acceleration magnitude maximum hypot(amax, vmax*wmax)),
% with the parameter intervals derived from the box (no published bounds).
    ...
    for betaMax = [0.005,0.015]
        ...
        nrmm.parameters = targetPrediction.nrmmParameters(center,radius,nrmm.contract,[]);
