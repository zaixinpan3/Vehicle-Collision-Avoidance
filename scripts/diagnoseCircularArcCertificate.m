...
% Directions are fixed on the cruise nominal; no branch search is performed.
    ...
    for curvature=[0,.0025,.01,.02]
        ...
        target=struct('trackId',1,'targetPositionInertial',p,'targetVelocityInertial',[0;0],'targetAccelerationInertial',[0;0],'targetHeadingInertial',yaw,'targetYawRate',0,'predictionMotion',struct('kind','finite-sensing-motion-v1','jerkBound',[0;0],'yawAccelerationBound',0));
