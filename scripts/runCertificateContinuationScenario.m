...
% This is a discrete-model experiment, not a nonlinear-plant validation.
    ...
    certificate = [];
    sampleCount = cfg.controller.horizonSteps+ltvBicycleModel.brakingSchedule("steps", cfg)+4;
    ...
    result = struct("scope", "declaredModelPredictionNodes", "sampleTime", cfg.controller.sampleTime, ...
        "performanceSteps", cfg.controller.horizonSteps, "continuationSteps", ltvBicycleModel.brakingSchedule("steps", cfg), ...
