    ...
    methods (Static)
        ...
        function [program,result,search]=nativeJoint(program,~,cfg)
            ...
            search=struct('hardSolves',called,'restorationSolves',0,'baseSolves',0,'nativeSolves',called, ...
                'familyAttempts',double(~program.inheritedPredictionFamily),'horizonAttempts',1, ...
                ...
                'policy',"fixedDirectionTrajectoryOptimization",'violationHistory',{{}},'usedCertifiedIncumbent',status==3, ...
                'issuedAdmissionWitness',false,'usedFullPlanAdmission',status==4, ...
                'initialCertificateAngles',initialAngles,'fixedCertificateAngles',angles, ...
