classdef nrmmCascadeCertificateTest < matlab.unittest.TestCase
    ...
    methods (Test)
        ...
        function targetDisturbanceBoundAssembles(testCase)
            ...
            scaledDomain = [bandwidth^2*domain.relativePositionMaximum; ...
                bandwidth*domain.speedMaximum;domain.accelerationNormBound];
            ...
            expectedBound = expectedInputScale*design.sensors.gyroscopeNoiseMaximum ...
                +bandwidth^3*sqrt(injection.'*metric*injection)*cfg.measurement.radar.noiseMaximum ...
                +sqrt(metric(3,3))*design.target.modelJerkMaximum;
