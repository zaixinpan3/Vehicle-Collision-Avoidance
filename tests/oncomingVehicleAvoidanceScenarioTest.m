...
% oncomingVehicleAvoidanceScenarioTest High-fidelity avoidance behavior.
    ...
    methods (Test)
        function limitedRoadCoverageDoesNotCertifyTheUnseenContinuation( ...
                testCase)
            ...
            testCase.verifyEqual( ...
                result.controlTime, 0.0, AbsTol=0.0);
        ...
        function anOutOfRangeTargetDoesNotSupplyAFutureContinuation( ...
                testCase)
            result = runOncomingVehicleAvoidanceScenario( ...
                Duration=0.3, ...
                Plot=false, Report=false);
